...
#ifndef _blehcoinRPC_H_
#define _blehcoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // blehcoin is not connected
...
/**
 * blehcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
